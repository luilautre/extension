...
function injectDevoirs(xmlString, timeline) {
  ...
  // Conteneur principal pour "Mes devoirs perso"
  ...
  // Place les devoirs après "Pour demain" si existant, sinon à la fin
